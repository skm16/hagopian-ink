      ...
      <section className="relative h-[70vh] min-h-[540px] flex flex-col justify-end overflow-hidden">
        ...
        <div className="relative z-20 px-8 md:px-16 pb-16 md:pb-24 max-w-[1400px] mx-auto w-full">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.9, ease }}>
            <p className="text-[10px] uppercase tracking-[0.22em] text-[#f5f0eb]/60 mb-5" style={{ fontFamily: NAV_FONT }}>Email Marketing</p>
        ...
        <div className="max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <FadeIn delay={0.2}>
            <p className="text-lg text-[#2d3232]/70 leading-relaxed mb-6">
              We have been designing and strategizing email programs for Fortune 50 brands and fast-growing startups since 2002. Email is the highest-ROI channel in digital marketing.
            </p>
            <p className="text-lg text-[#2d3232]/70 leading-relaxed">
              Our approach combines beautiful design with thoughtful strategy: the right message, to the right audience, at exactly the right moment.
            </p>
          </FadeIn>
        </div>
      </section>
