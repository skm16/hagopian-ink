...
export const CLIENT_LOGOS = [
  ...
  { src:`${CDN}/2018/09/10_HI_logo_vuitton.png`,      alt:'Louis Vuitton' },
  { src:`${CDN}/2018/09/11_HI_logo_frette.png`,       alt:'Frette' },
  { src:`${CDN}/2018/09/12_HI_logo_nyx.png`,          alt:'NYX' },
  { src:`${CDN}/2018/09/13_HI_logo_coach.png`,        alt:'Coach' },
  { src:`${CDN}/2018/09/14_HI_logo_shopbop.png`,      alt:'Shopbop' },
  { src:`${CDN}/2018/09/15_HI_logo_saks.png`,         alt:'Saks' },
  { src:`${CDN}/2018/09/16_HI_logo_bloomingdales.png`,alt:"Bloomingdale's" },
  { src:`${CDN}/2018/09/17_HI_logo_neimanmarcus.png`, alt:'Neiman Marcus' },
  { src:`${CDN}/2018/09/18_HI_logo_josbank.png`,      alt:"Jos. A. Bank" },
  { src:`${CDN}/2018/09/19_HI_logo_gwynniebee.png`,   alt:'Gwynnie Bee' },
  { src:`${CDN}/2018/09/20_HI_logo_frenchconnection.png`, alt:'French Connection' },
  { src:`${CDN}/2021/10/21_HI_logo_pvolve.png`,       alt:'P.Volve' },
  { src:`${CDN}/2021/10/22_HI_logo_viantmedical.png`, alt:'Viant Medical' },
  { src:`${CDN}/2021/10/23_HI_logo_audible.png`,      alt:'Audible Books' },
  { src:`${CDN}/2021/10/24_HI_logo_cannadips.png`,    alt:'Cannadips' },
];
