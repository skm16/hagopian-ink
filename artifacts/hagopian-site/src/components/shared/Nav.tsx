...
const NAV_LINKS = [
  ...
  { label: 'About',     href: 'https://hagopianink.com/wbe-branding-agency/' },
  { label: 'Blog',      href: 'https://hagopianink.com/blog/' },
  { label: 'Contact',   href: 'https://hagopianink.com/contact/' },
];
        ...
        {NAV_LINKS.map(({ label, path, href }) =>
          path ? (
            ...
            <a key={label} href={href} target="_blank" rel="noopener noreferrer"
              className="hover:text-[#f5f0eb] transition-colors duration-250">
              {label}
            </a>
          )
        )}
