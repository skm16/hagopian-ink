      ...
      <section className="bg-[#0a0a0a] py-28 md:py-44 px-6 md:px-12 border-t border-[#191919]">
        <div className="max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-start">
          ...
          <FadeIn>
            ...
            <h2 className="text-4xl md:text-6xl mb-8 leading-[1.02]" style={{ fontFamily: SERIF, fontWeight: 700 }}>
              Good design is good business.
            </h2>
            <p className="text-xl font-light text-[#f5f0eb]/50 mb-6" style={{ fontFamily: SERIF }}>
              Let us create together.
            </p>
            <p className="text-lg text-[#f5f0eb]/50 leading-relaxed mb-14 max-w-lg">
            ...
            <div className="flex flex-col gap-5 mb-14">
              <a href="mailto:info@HagopianInk.com"
                className="flex items-center gap-4 text-[14px] text-[#f5f0eb]/60 hover:text-[#f5f0eb] transition-colors duration-250">
              ...
              <div className="flex items-center gap-4 text-[14px] text-[#f5f0eb]/40">
                <div className="w-10 h-10 border border-[#252525] flex items-center justify-center flex-shrink-0">
          ...
          {/* Right — form */}
          <FadeIn delay={0.2} className="bg-[#111111] border border-[#1e1e1e] p-10">
            {submitted ? (
              <div className="text-center py-16">
                <div className="text-4xl mb-6" style={{ fontFamily: SERIF }}>Thank you.</div>
                <p className="text-[#f5f0eb]/55 text-lg leading-relaxed">
              ...
              <>
                ...
                <form className="space-y-5" onSubmit={e => { e.preventDefault(); setSubmitted(true); }}>
                  {[
                    ...
                    <div key={i}>
                      ...
                      <input type={field.type} required={field.required}
                        className="w-full bg-[#171717] border border-[#3d3d3d] text-[#f5f0eb] placeholder-[#f5f0eb]/35 text-sm px-4 py-3 focus:outline-none focus:border-[#f5f0eb]/55 transition-colors"
                  ...
                  <div>
                    ...
                    <select className="w-full bg-[#171717] border border-[#3d3d3d] text-[#f5f0eb]/80 text-sm px-4 py-3 focus:outline-none focus:border-[#f5f0eb]/55 transition-colors appearance-none"
                  ...
                  <div>
                    ...
                    <textarea rows={4} required
                      className="w-full bg-[#171717] border border-[#3d3d3d] text-[#f5f0eb] placeholder-[#f5f0eb]/35 text-sm px-4 py-3 focus:outline-none focus:border-[#f5f0eb]/55 resize-none transition-colors"
                      placeholder="Tell us about your project..."
                      style={{ fontFamily: SANS }} />
                  </div>
                  <button type="submit"
                    className="w-full py-4 bg-[#f5f0eb] text-[#0a0a0a] text-[11px] uppercase tracking-[0.16em] hover:bg-white transition-colors duration-300 mt-4"
                    style={{ fontFamily: NAV_FONT }}>
                    Send Message
                  </button>
                </form>
