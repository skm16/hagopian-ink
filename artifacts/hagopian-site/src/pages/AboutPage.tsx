...
const VALUES = [
  ...
  { icon: Star,      title: 'Woman-Owned, Creatively Driven',   desc: 'We lead with intention, high expectations, and a healthy dose of boss-lady energy. Woman-owned and proud. But what really drives us is an unapologetic commitment to doing exceptional work.' },
      ...
      <section className="relative h-[70vh] min-h-[540px] flex flex-col justify-end overflow-hidden">
        ...
        <div className="relative z-20 px-8 md:px-16 pb-16 md:pb-24 max-w-[1400px] mx-auto w-full">
          ...
          <motion.h1 initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.9, delay: 0.15, ease }}
            className="text-6xl md:text-8xl leading-[0.92] mb-0 text-white" style={{ fontFamily: SERIF, fontWeight: 700 }}>
            We help you make<br />
